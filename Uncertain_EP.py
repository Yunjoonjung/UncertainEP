...
class Uncertain_EP(object):
    ...
    def __init__(self, IDF_FileName, epw_FileName,IDD_FileName, outputFile, SA_Graph=True, UA_Graph=True):
...
#-----------------------------------------------------------------------------------------------------------------------------------#
    def SA(self, number_of_SA_samples=1000): # number_of_SA_samples
        ...
        self.distribution_repository = np.zeros((self.number_of_SA_samples, self.number_of_parameter_uncertain_parameters))
        ...
        design_lhs = lhs(self.number_of_parameter_uncertain_parameters, samples=self.number_of_SA_samples)
...
#-----------------------------------------------------------------------------------------------------------------------------------#
    def UA(self, number_of_UA_samples=1000, only_idf_instances_generation=True):
        ...
        self.number_of_parameter_uncertain_parameters = uncertain_input_sheet.cell(row=2, column=14).value
        self.distribution_repository = np.zeros((self.number_of_UA_samples, self.number_of_parameter_uncertain_parameters))
        ...
        # Uncertainty quantification (only parameter uncertainty)
        design_lhs = lhs(self.number_of_parameter_uncertain_parameters, samples=self.number_of_UA_samples)
